...
def score_hand(hand):
    # Calculate the total score of all the cards
    # Only one ace can hold the value 11 and will reduce to 1 if would bust.
    score = 0
    ace = False
    for next_card in hand:
        ...
        if card_value == 1 and not ace:
            ...
            card_value = 11
        score += card_value
    # if we would bust check to see if there is an ace and -10
        if score > 21 and ace:
            score -= 10
            ace = False
    return score
